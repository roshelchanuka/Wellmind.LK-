...
<head>
  ...
  <title>Support - WellMind LK</title>
...
<body class="lang-en support-page">
    ...
    <nav class="nav">
      ...
      <div class="nav__menu" id="nav-menu">
        ...
        <ul class="nav__list">
          ...
          <li><a href="support.php" class="nav__link active" data-key="support">Support</a></li>
  ...
  <section class="hero support-bg-card" id="heroSection">
    <div class="hero-overlay"></div>
    <div class="hero-content">
      <h1 class="pop-in" data-key="supportHeroTitle">How can we help you?</h1>
      <p class="pop-in" data-key="supportHeroText">We are here to support your mental health journey.</p>
    </div>
  </section>
  ...
  <section class="rating-section">
    <div class="container" style="max-width: 800px; margin: 0 auto;">
      <h3 id="ratingPromptText" data-key="ratingPrompt" style="color: #2a5421; font-size: 1.6rem; margin-bottom: 25px; font-weight: 700; line-height: 1.4;">
      ...
      <div class="star-rating-container">
          <div class="radio">
            <input value="5" name="rating-stars" type="radio" id="st-5" />
            <label title="5 stars" for="st-5">
            ...
            <input value="4" name="rating-stars" type="radio" id="st-4" />
            <label title="4 stars" for="st-4">
              <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512"><path d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z"></path></svg>
            </label>
            <input value="3" name="rating-stars" type="radio" id="st-3" />
            <label title="3 stars" for="st-3">
              <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512"><path d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z"></path></svg>
            </label>
            <input value="2" name="rating-stars" type="radio" id="st-2" />
            <label title="2 stars" for="st-2">
              <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512"><path d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z"></path></svg>
            </label>
            <input value="1" name="rating-stars" type="radio" id="st-1" />
            <label title="1 star" for="st-1">
              <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512"><path d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z"></path></svg>
            </label>
          </div>
      </div>
  ...
  <!-- Feedback Section (Displays existing reviews) -->
  <section class="container reviews-section">
    <h2 class="section-title" data-key="userFeedbacksTitle">User Feedbacks</h2>
    <div class="reviews-grid">
      <?php
      include 'db_connect.php';
      // Fetch feedbacks from support_messages
      $stmt = $conn->prepare("SELECT user_name, feedback_text, created_at FROM support_messages ORDER BY created_at DESC");
      $stmt->execute();
          ...
          <div class="review-card">
            <div class="review-header">
              <div class="review-user">
                <div class="user-avatar"><?php echo strtoupper(substr($row['user_name'], 0, 1)); ?></div>
                <div class="user-info">
                  <h4 class="user-name"><?php echo htmlspecialchars($row['user_name']); ?></h4>
                  <p class="review-date"><?php echo date("F j, Y, g:i a", strtotime($row['created_at'])); ?></p>
                </div>
              </div>
            </div>
  ...
  <!-- Feedback Modal (Liquid Glass Form) -->
  ...
  <script>
    ...
    // Local script for feedback interactions
    document.addEventListener('DOMContentLoaded', function() {
      ...
      floatBtn.addEventListener('click', () => {
        ...
        document.body.classList.add('modal-blurred');
      });

      closeBtn.addEventListener('click', () => {
        modal.classList.remove('active');
        document.body.classList.remove('modal-blurred');
      });
      ...
      // AJAX Submission - Feedback Modal
