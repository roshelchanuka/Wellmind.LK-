...
<form class="form" method="POST" action="login.php">
    ...
    <?php if(!empty($error)) echo "<div class='error-msg-auth'>$error</div>"; ?>
    ...
    <div class="flex-row">
      ...
      <a href="forgot_password.php" class="span">Forgot password?</a>
    </div>
    
    <button type="submit" class="button-submit">Sign In</button>
    <p class="p">Don't have an account? <a href="register.php" class="span">Sign Up</a></p>
